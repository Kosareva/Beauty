...
$(document).ready(function(){function e(){var e;$(".carousel-services-item").each(function(){var s=$(this);e=s.find(".carousel-services-content").outerHeight(),s.find(".carousel-services-image").css("min-height",e+"px")})}function s(){$(".carousel-services-content").equalHeights(),e()}e(),$("#my-menu").mmenu({extensions:["pagedim-black","theme-dark"],offCanvas:{position:"right"},navbar:{title:'<img src="img/logo.svg" alt="Салон красоты L&Lubiy">'}});var i=$("#my-menu").data("mmenu");i.bind("open:finish",function(){$(".hamburger").addClass("is-active")}),i.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".owl-carousel.carousel-services").on("initialized.owl.carousel",function(){setTimeout(function(){e()},100)}),$(".owl-carousel.carousel-services").owlCarousel({dots:!1,nav:!0,smartSpeed:300,navText:['<i class="fa fa-angle-double-left"></i>','<i class="fa fa-angle-double-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},800:{items:2},1100:{items:3}}}),$(".carousel-services-content").equalHeights(),e(),$(".carousel-services-composition .h3").each(function(){var e=$(this);e.html(e.html().replace(/(\S+)\s*$/,"<span>$1</span>"))}),$("section .h2").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<span>$1</span>"))}),$(".owl-carousel.reviews").owlCarousel({items:1,loop:!0,smartSpeed:700,nav:!1,dots:!0,autoHeight:!0}),$(".owl-carousel.partners, .owl-carousel.examples").owlCarousel({items:1,loop:!0,smartSpeed:700,nav:!0,dots:!1,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsiveClass:!0,responsive:{768:{items:2},992:{items:3},1200:{items:4}}}),$("select").selectize({create:!0}),s(),window.onresize=function(){s()},$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"/mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1}),$(".preloader").delay(1e3).fadeOut("slow")});